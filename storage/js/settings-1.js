...
<script src="/storage/js/parts.js"></script>
  <script src="/storage/js/ap.js"></script>


    <div class="background"><div id="parts"></div></div>
    <div class="container">
        <h1>404</h1>
        <ul>
            ...
            <li>Contact @voucan if the issue persists</li>
        </ul>
